# Agentic Engineering: Greenfield — репозиторій для практики

Курс **fwdays Academy · Agentic Engineering: Greenfield**.

Головне — **не про розмір продукту, а про процес**: показати, що ти вмієш будувати з нуля, керуючи AI-агентами **інженерно** (контекст, цикли, верифікація, maker ≠ checker), а не «вайбкодити».
