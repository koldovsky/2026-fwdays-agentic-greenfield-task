...
- **Docs**: `README.md`, product output in `output/` (articles, glossary cards). Humans read these end-to-end.
...
Ukrainian: user-facing chat, `README.md`, PR body, product output in `output/`.
English: everything else — `AGENTS.md`, `CLAUDE.md`, `STATUS.md`, `TODO.md`, specs, code, commit messages, code comments.
...
| `README.md`, PR body, `output/` | uk | prose |
| `AGENTS.md`, `CLAUDE.md`, `STATUS.md`, `TODO.md`, specs | en | caveman |
