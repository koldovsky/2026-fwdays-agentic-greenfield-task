...
const commands = [
  ...
  // db-integration-tests / browser-e2e-tests / eval-ratchet are omitted until
  // those layers exist in this repo (no test:integration, test:e2e, or
  // evals/results/latest.json yet). Re-add when the orchestrator stands them up.
  {
    name: "lint",
    command: "npm",
    args: ["run", "lint"],
