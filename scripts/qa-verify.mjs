...
const commands = [
  ...
  // Stack-dependent gates trimmed at init (greenfield, stack-agnostic): re-add
  // unit-tests/db-integration/e2e (`npm run test:*`), lint, production-build,
  // and openspec validate/list at the Phase 1 stack decision, once that tooling
  // exists. qa-verify's battery must list only scripts that actually exist.
];
