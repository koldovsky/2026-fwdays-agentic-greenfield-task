...
// Free, ungated CV text intake (gate-premium-upload-zone, T4; FR-CV-01,
// FR-ONBOARD-01). Drag-and-drop / click-to-browse a PDF or DOCX; the parsed
// plain text goes up through `onExtracted`. This zone knows nothing about paid
// status or the premium attachment — that lives in PremiumAttachZone. Client
// validation here is UX only; `/api/cv/parse` re-validates as the trust
// boundary (NFR-SEC-04).
...
export function TextUploadZone({ locale = "ua", onExtracted }: TextUploadZoneProps) {
