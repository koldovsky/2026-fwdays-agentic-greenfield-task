---
name: honesty-eval
description: Author and run evals for Vouch's honesty core — the two-pass grounding and overclaim-risk detection. Use when building or changing prompts or the tailoring pipeline, or on "add evals", "test grounding", "check overclaim detection".
metadata:
  author: vouch
  version: "1.0"
---
