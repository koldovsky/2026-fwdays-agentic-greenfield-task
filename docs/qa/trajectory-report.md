...
| 2026-06-29-add-watering | clean | 2 | yes | watering, i18n |

## Cross-slice module overlap

- `lib/i18n/` touched by: 2026-06-29-add-app-shell, 2026-06-29-add-growth, 2026-06-29-add-plants, 2026-06-29-add-watering
...
- **in-scope**: lib/i18n/ modified by 4 slices (2026-06-29-add-app-shell, 2026-06-29-add-growth, 2026-06-29-add-plants, 2026-06-29-add-watering) — review for scope drift
