...
а **LLM-judge** (`evals/cases/coach-persona-tone.eval.ts`, рубрика тону з CRITICAL-cap +
...
рішення про бренд/тон (**спокійний, чесний, non-moralizing coach-голос — ADR-0015**), і скеровував
цикл по одному слайсу, а не давав агенту працювати без нагляду від початку
