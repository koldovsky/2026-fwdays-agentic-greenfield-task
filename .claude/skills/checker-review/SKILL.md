---
name: checker-review
description: Independent maker≠checker review of a Vouch diff — audits against PRD requirement IDs, DESIGN.md brand rules, FSD import rules, and NFRs. Use before merging, on "review this diff/PR", or as a second pass after implementing. Produces findings, not code.
metadata:
  author: vouch
  version: "1.0"
---
