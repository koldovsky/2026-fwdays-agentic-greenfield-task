---
name: agent-verify
description: Verify a change against Vouch's requirements — build, typecheck, lint, run tests, exercise the touched FR/NFR, and report pass/fail with evidence. Use after implementing a change, before a handoff or PR, or when asked to "verify", "check it works", or "prove the requirement".
metadata:
  author: vouch
  version: "1.0"
---
