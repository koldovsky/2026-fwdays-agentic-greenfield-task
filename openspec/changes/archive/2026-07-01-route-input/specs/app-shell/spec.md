...
#### Scenario: Submit without routing

- **WHEN** the visitor activates the route planning submit control
- **THEN** the form validates all inputs
- **THEN** no map, sidebar itinerary, or external routing request is triggered in this phase
