...
When the input contains multiple expenses, datetime inference SHALL be applied **independently to each expense object** in the returned array, using the same injected receipt timestamp as the base for relative and no-time cases.
