...
Defines the end-to-end export orchestration behind the popup's Export button: DOM extraction from the active tab, optional anonymization, Markdown serialization, folder/file naming, and separate downloads of the `.md` and each attachment — including the FR-12 partial-success contract.
