...
Wizard step 1: choose document type (`invoice_act` / `invoice` / `act`) and optionally copy business fields from another session guid without copying document numbers (FR-03, FR-04, BC-01, BC-11, NFR-03, NFR-04, NFR-10).
