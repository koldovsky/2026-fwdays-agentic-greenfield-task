...
Defines the animated weather background capability: a fullscreen fixed-position layer that reflects the current weather condition and time of day for the active location, including condition-driven gradients and particle overlays, day/night determination from forecast data, reduced-motion accessibility compliance, and a pure utility function for condition mapping.
