...
The city-search capability lets a visitor choose the active location for future
forecast and map slices. It uses the keyless Open-Meteo geocoding API, keeps
location intent explicit, and reflects the selected location in the URL.
