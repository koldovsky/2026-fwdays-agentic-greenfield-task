...
Objective quality gate for askdocs: a golden set of known-answer questions over the ГущоЛіт corpus, a retrieval hit-rate metric, and an anti-hallucination refusal-rate metric. Covers PRD FR-040, FR-041, FR-042.
