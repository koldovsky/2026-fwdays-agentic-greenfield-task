...
Specification for the Pokémon detail page (`/pokemon/[id]`). Defines what information is displayed, how it is formatted, and how users navigate to and from the page.
