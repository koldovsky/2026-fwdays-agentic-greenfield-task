# Capability: Langsmith Evaluators

## Purpose

Custom Langsmith evaluators that measure parser accuracy across category, amount, and confidence calibration dimensions by comparing extracted expense data against expected reference values.
