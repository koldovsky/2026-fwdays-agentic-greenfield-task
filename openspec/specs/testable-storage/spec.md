# Capability: Testable Storage

## Purpose

Make storage operations testable without a live PostgreSQL instance by exposing an `ExpenseStore` class whose database connection is produced by an injectable connection factory.
