...
Generate A4 PDFs from filled invoice/act HTML, expose a download API, and present wizard step 7 / completed final review as a read-only view with PDF download, Back, and Edit (FR-15, FR-16, NFR-07, NFR-10, BC-12).
