# Converter (UAH ⇄ currency)

## Purpose
Convert between UAH and the active currency at the official rate, with
locale-aware input and output and total, never-crashing arithmetic.
