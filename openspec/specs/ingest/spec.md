...
Load documents from a `DocSource` (v1: local `.md` files), chunk them preserving markdown structure, embed them, and persist them idempotently to the vector store with source metadata sufficient for citation. Covers PRD FR-001–FR-004.
