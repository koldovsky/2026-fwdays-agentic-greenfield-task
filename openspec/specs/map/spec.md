...
The map capability renders a client-only OpenStreetMap panel centered on the active
location, lets visitors click to set a new place via Open-Meteo reverse geocoding,
and shows required OSM attribution.
