...
## Purpose
Provide the single-page application shell — header, main, footer — its responsive
layout, theme toggle, and honest empty/loading states, so every capability renders
inside one calm, consistent Ukrainian-first surface.
