...
The shell capability owns the single-screen PWA experience: the main "next break"
view, the quiet navigation to Settings and Stats, the mobile-first responsive
layout, the first-run state, and the breathing-ring states defined in DESIGN.md.
It keeps the breathing ring as the calm focal point and honors `prefers-reduced-motion`.
