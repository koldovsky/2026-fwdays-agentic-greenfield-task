...
Defines the requirements for deterministic Ukrainian weather jokes displayed in the app footer, along with footer attribution links. Jokes are day-seeded (no external API), stored in the i18n module, and follow the calm Ukrainian brand voice.
